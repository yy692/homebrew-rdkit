...
class Rdkit < Formula
  ...
  url "https://github.com/yy692/rdkit/archive/v0.1-alpha.5.tar.gz"
  sha256 "b3298a7f90fe09c59a4bf5360b7c82bcb15e43277fd4db73e941d53645d09adb"
  ...
  depends_on "rdkit/rdkit/boost@1.70"
  depends_on "eigen" => :recommended
  depends_on "python3" => :optional
  depends_on "postgresql" => :optional

  # Different dependencies if building for python3
  depends_on "rdkit/rdkit/boost-python3@1.70"
